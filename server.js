...
const IDENTIFICATION_CODE = 'BIC' // this is the identification code for the banks(Turkey)
...
console.log(generateQrCode({
	name: 'bashiru bukari',
	iban: 'TR72000000001616',
	amount: 123.45,
	reference: 'water bill payment',
	information: 'testing encoded qr code for payment'
}))
